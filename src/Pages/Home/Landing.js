...
const Landing = () => {
    return (
        <>
            <div class="hero h-screen lg:h-[60vh] bg-accent mt-16">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        data-aos-delay="400" class="text-5xl font-bold">
                            Professional Cleaning Service
                        </h1>
                        <p data-aos="fade-right" data-aos-duration="800"
                        data-aos-delay="600" class="py-6 max-w-xl">
            ...
            <div className='rounded-2xl mx-auto mt-[-20px] relative z-20 bg-base-200 shadow-lg p-10 w-5/6'>
